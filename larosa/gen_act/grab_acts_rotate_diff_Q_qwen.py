...
from inference.model import Qwen2SparseForCausalLMRotate, Qwen2SparseConfig
...
if __name__ == '__main__':
    ...
    model = Qwen2SparseForCausalLMRotate.from_pretrained(args.model_name, torch_dtype=torch.bfloat16, device_map="auto", attn_implementation="flash_attention_2", histogram_path=os.path.join(args.output_path, "histograms"), grab_acts=True, rot=False)
