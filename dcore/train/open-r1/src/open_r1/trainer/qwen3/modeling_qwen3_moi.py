...
from .moi_modeling_flash_attention_utils import moi_flash_attention_forward
...
QWEN3_MOI_ATTENTION_FUNCTIONS = {
    "flash_attention_2": moi_flash_attention_forward
}
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if self.config._attn_implementation != "eager":
            if self.config._attn_implementation == "sdpa" and kwargs.get("output_attentions", False):
                ...
                attention_interface = QWEN3_MOI_ATTENTION_FUNCTIONS[self.config._attn_implementation]
...
class Qwen3AttentionFlash2(Qwen3Attention):
    def __init__(self, config: Qwen3Config, layer_idx: int):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        if self.config._attn_implementation == "eager":
            ...
            bsz, q_len, input_shape = hidden_states.size()
...
class Qwen3DecoderLayer(nn.Module):
    def __init__(self, config: Qwen3Config, layer_idx: int):
        ...
        self.self_attn = Qwen3AttentionFlash2(config=config, layer_idx=layer_idx)
