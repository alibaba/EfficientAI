...
project_name='D-CORE'
export EXPERIMENT_NAME="GSPO-Qwen3-8B-D-Core-TEMP-16k-MOI"

rollout_data_dir="rollout_log/gspo_Qwen3_8B"
validation_data_dir="validation_log/gspo_Qwen3_8B"
set -x
...
adv_clip_ration_low=0.0003
adv_clip_ratio_high=0.0004
adv_clip_ratio=0.0004
