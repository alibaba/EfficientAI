...
project_name='D-CORE'
export EXPERIMENT_NAME="DA-GRPO-Qwen3-8B-D-Core-TEMP-16k-MOI-alpha0.1-beta0.5"

rollout_data_dir="rollout_log/da_grpo_Qwen3_8B_alpha_0.1_beta_0.5"
validation_data_dir="validation_log/da_grpo_Qwen3_8B_alpha_0.1_beta_0.5"
set -x
