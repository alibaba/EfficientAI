...
project_name='D-CORE'
export EXPERIMENT_NAME="GRPO-with-DS-Qwen3-8B-D-Core-TEMP-16k-MOI"

rollout_data_dir="rollout_log/grpo_with_ds_Qwen3_8B"
validation_data_dir="validation_log/grpo_with_ds_Qwen3_8B"
set -x
