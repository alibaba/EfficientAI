...
project_name='D-CORE'
export EXPERIMENT_NAME="KL-Conv-Qwen3-8B-D-Core-TEMP-16k-MOI"

rollout_data_dir="rollout_log/grpo_Qwen3_8B"
validation_data_dir="validation_log/grpo_Qwen3_8B"
set -x
...
kl_coef=0.0
use_kl_loss=False   # grpo 在actor当中使用kl损失, kl_conv当前不使用
